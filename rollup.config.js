...
if ((process.env.BUILD !== 'production')) {
    ...
    componentPath = "https://lcagmac.github.io/vue-apps/";
    serverPath = "https://lcagmac.github.io/core-components/";
}
...
export default ['index', 'main-room'].map((name, index) => ({
    ...
    plugins: [
        ...
        replace({
            ...
            'https://lcagmac.github.io/vue-apps/': componentPath //JSON.stringify( componentPath )
        }), 
        typescript({
